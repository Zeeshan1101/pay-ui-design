...
const LastMonthStats = () => {
  return (
    <>
      <div className="flex flex-col items-center w-full gap-3 px-4 py-2 bg-white md:w-max lg:w-3/5 rounded-2xl sm:flex-row shadow-2 month-info">
        <div className=" lg:whitespace-nowrap">Last 30 Days:</div>
        <div className="flex flex-col w-full gap-1 text-center text-white sm:text-left sm:flex-row">
